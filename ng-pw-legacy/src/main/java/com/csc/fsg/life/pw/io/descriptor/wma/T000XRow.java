...
@JsonPropertyOrder({ "companyCode", "productPrefixJson", "productSuffix", "planCode", "issueState", "lineOfBusiness", "effectiveDate", "planType", "tablePtrId", "tablePtrVar", "tablePtrSubset" })
public class T000XRow
    extends Row
{
